...
export default function Footer() {
  return (
    <footer className="relative bg-[#4b382a] text-[#f5e9d7] py-6 px-4 md:px-8 fonty overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center z-10">
        ...
        <div className="flex flex-col text-xl space-y-2 text-center md:text-right">
          <Link href="/home" className="cursor-pointer z-30 hover:opacity-75 transition">
            Home
          </Link>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden z-0 cursor-default">
        <h1 className="text-[5.5rem] md:text-[16rem] font-bold text-[#f5e9d7] opacity-20 leading-none tracking-wide whitespace-nowrap overflow-hidden">
          BREW NEXUS
        </h1>
      </div>
    </footer>
